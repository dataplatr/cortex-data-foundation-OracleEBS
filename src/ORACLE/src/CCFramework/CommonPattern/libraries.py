...
from airflow.providers.oracle.operators.oracle import OracleOperator     #Library to import Bash Operatot to make use bash commands or to execute Shell scripts
