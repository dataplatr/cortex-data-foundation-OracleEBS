...
![Enter image alt description](Images/2Dx_Image_1.png)
...
A storage bucket will be required to store DAG scripts and logs generated during deployment. These scripts will have to be manually moved into a Cloud Composer or Apache Airflow instance after deployment.
...
![Enter image alt description](Images/x5f_Image_2.png)
